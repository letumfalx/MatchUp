    ...
    value: function Game(o) {
            ...
            current: {
                ...
                set: function(name) {
                    if(GMPixi.checkType(GMPixi.checkType(name, String) 
                            ? this.rooms[name] : name, GMPixi.Room)) {
                        room_current = name;
                    }
                    else {
            ...
            change: {
                value: function(rname, reset, override) {
                    ...
                    var typeName = GMPixi.checkType(rname, String) 
                            ? String : GMPixi.checkType(rname, GMPixi.Room) 
                            ? GMPixi.Room : null;
        ...
        var setup = function() {
            ...
            if(GMPixi.checkType(o.rooms, Object)) {
                ...
                setTimeout(this._update.bind(this), 3);
...
Object.defineProperties(GMPixi.Game.prototype, {
    _update: {
        value: function () {
            if(GMPixi.checkType(this.room.current, GMPixi.Room)) {
